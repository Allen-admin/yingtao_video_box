...
public class RegsUtil {
     ...
     * 数是不是大于0
     *
     * @param number 验证的number
     * @return
     */
    public static boolean valiIsNonnegative(Integer number) {
        if (!validateNull(number)) {
            return number > 0;
        } else {
            return false;
        }
     ...
     * @return
     */
    public static boolean validateMacAddr(String name) {
